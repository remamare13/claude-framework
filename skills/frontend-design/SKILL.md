...
description: Use when someone asks to build a web component, page, application, or interface. Creates distinctive, production-grade frontend with high design quality that avoids generic AI aesthetics.
user_invocable: true
---
...
- Always include mobile breakpoints (`<768px` minimum)
- Test that layouts degrade gracefully — not just "smaller," but *redesigned* for touch
